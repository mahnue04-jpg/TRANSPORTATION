...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("gross_customer_charge_usd", sa.Float(), nullable=False),
        sa.Column("driver_earning_usd", sa.Float(), nullable=True),
        sa.Column("amicor_share_usd", sa.Float(), nullable=True),
        sa.Column("processing_fee_usd", sa.Float(), nullable=True),
        sa.Column("refund_amount_usd", sa.Float(), nullable=False),
