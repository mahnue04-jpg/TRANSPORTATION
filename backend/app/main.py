...
@app.get("/nova/workspace")
def serve_nova_workspace() -> Response:
    page = os.path.join(_static_dir, "nova-workspace", "index.html")
    if os.path.isfile(page):
        return FileResponse(page, media_type="text/html")
...
@app.get("/nova/government")
def serve_nova_government() -> Response:
    page = os.path.join(_static_dir, "nova-government", "index.html")
    if os.path.isfile(page):
        return FileResponse(page, media_type="text/html")
...
@app.get("/nova/work")
def serve_nova_work() -> Response:
    page = os.path.join(_static_dir, "nova-work", "index.html")
    if os.path.isfile(page):
        return FileResponse(page, media_type="text/html")
...
@app.get("/nova/accounting/aging")
def serve_nova_accounting_aging() -> Response:
    page = os.path.join(_static_dir, "nova-accounting", "aging.html")
    if os.path.isfile(page):
        return FileResponse(page, media_type="text/html")
